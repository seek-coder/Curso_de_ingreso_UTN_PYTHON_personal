...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        hour = self.txt_hora.get()
        hour_int = int(hour)

        match(hour_int):
            case 7 | 8 | 9 | 10 | 11 :
                info_hour = "Es de mañana"
            case 12 | 13 | 14 | 15 | 16 | 17 | 18 | 19 :
                info_hour = "Es de tarde"
            case 0 | 1 | 2 | 3 | 4 | 5 | 6 | 20 | 21 | 22 | 23 | 24 :
                info_hour = "Es de noche"
            case _ :
                info_hour = "La hora no existe"
        alert(title="mensaje",message=info_hour)
