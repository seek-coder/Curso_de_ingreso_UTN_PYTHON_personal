...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if (num_random >= 6):
            aviso_nota = "Promoción directa, la nota es... "
        elif (num_random > 3):
            aviso_nota = "Aprobado, la nota es... " 
        else:
            aviso_nota = "Desaprobado, la nota es... "

        alert(title="Mensaje", message= aviso_nota + str(num_random))
