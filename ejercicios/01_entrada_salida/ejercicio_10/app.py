...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        importe_actualizado = importe_float - ((descuento_float * importe_float) / 100)
        importe_actualizado_float = float(importe_actualizado)

        alert(title="Importe actualizado", message="Su importe actualizado, luego del descuento, es de " + str(importe_actualizado_float))
